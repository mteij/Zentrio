...
export default function Footer() {
  return (
    <footer class="w-full text-gray-400 text-sm p-4 mt-auto relative z-10">
      <div class="max-w-4xl mx-auto text-center space-y-2">
        ...
        <div class="text-xs text-gray-500 pt-2">
          <p>
            ...
            and will comply with any and all takedown or cease and desist notices from Stremio or its legal representatives.
            For the official Stremio website, please visit <a href="https://www.stremio.com" target="_blank" rel="noopener noreferrer" class="underline hover:text-gray-300">stremio.com</a>.
          </p>
        </div>
      </div>
    </footer>
