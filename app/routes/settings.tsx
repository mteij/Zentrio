...
export default function SettingsPage(_props: PageProps) {
  ...
  return (
    <div class="min-h-screen flex flex-col items-center justify-center bg-black px-2">
      <div
        class="w-full max-w-3xl bg-gray-900 rounded-lg shadow-2xl p-4 sm:p-8 relative mt-6 sm:mt-12 flex flex-col"
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            // background and shadow to overlay scrollable content
              ...
              <div class="mb-6">
                ...
                {autoLogin.value === "profile" && profiles.value.length > 0 && (
                  ...
                  >
                    ...
                    {profiles.value.map((p: { _id: string; name: string }) => (
