      ...
      <div id="app-titlebar" className="titlebar" style={{ display: 'none' }}>
        ...
        <div className="titlebar-controls">
          <div className="titlebar-button" id="titlebar-minimize">
            <span className="iconify" data-icon="mdi:minus" data-width="16" data-height="16"></span>
          </div>
          <div className="titlebar-button" id="titlebar-maximize">
            <span className="iconify" data-icon="mdi:window-maximize" data-width="16" data-height="16"></span>
          </div>
          <div className="titlebar-button titlebar-close" id="titlebar-close">
            <span className="iconify" data-icon="mdi:window-close" data-width="16" data-height="16"></span>
          </div>
        </div>
      </div>
