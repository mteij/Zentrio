      ...
      <div class="container nav-content">
        ...
        <div class="nav-links">
          ...
          <div class="nav-actions">
            <a href="https://github.com/mteij/Zentrio" target="_blank" class="icon-btn" aria-label="GitHub">
            ...
            <button @click="toggleTheme" class="icon-btn" aria-label="Toggle Theme">
              <svg v-if="isDark" viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    <footer class="footer">
      <div class="container">
        <div class="footer-content">
          ...
          <p class="copyright">&copy; {{ currentYear }} Zentrio. Open Source Software.</p>
        </div>
      </div>
    </footer>
  </div>
